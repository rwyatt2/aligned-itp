    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Usage ratio indicator */}
          <div className="absolute bottom-4 left-4 right-4" style={{ transform: 'translateZ(20px)' }}>
            <div className="rounded-full h-1.5 overflow-hidden backdrop-blur-md" style={{ backgroundColor: isLight ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.15)' }}>
              <motion.div
                className="h-full rounded-full"
                style={{ backgroundColor: isLight ? 'rgba(0,0,0,0.4)' : 'rgba(255,255,255,0.6)' }}
                initial={{ width: 0 }}
                whileInView={{ width: `${color.ratio}%` }}
                viewport={{ once: true }}
            ...
            {values.map((v) => (
              ...
              >
                <span className="flex items-center gap-3">
                  ...
                  <span className="font-semibold tracking-wide" style={{ color: 'var(--text-primary)' }}>{v.value}</span>
                </span>
